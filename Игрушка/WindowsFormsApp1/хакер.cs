    ...
    public partial class хакер : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (randomValue < chance)
            {
                ...
                MessageBox.Show("Ты взломал бабушку");
                form1.point += 1;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (form1.status == "бомжара" )
            {
                ...
                if (randomValue < chance)
                {
                    ...
                    MessageBox.Show("взломал дедушку");
                    form1.point += 3;
                    form1.lblPoint.Text = form1.point.ToString();
                    labelstatus.Text = form1.lblStatus.Text.ToString();
                    labelpoint.Text = form1.lblPoint.Text.ToString();
            ...
            else if (form1.status == "Чел из норбита")
            {
                ...
                if (randomValue < chance)
                {
                    ...
                    MessageBox.Show("взломал сайт школы");
                    form1.point += 3;
                    form1.lblPoint.Text = form1.point.ToString();
                    labelstatus.Text = form1.lblStatus.Text.ToString();
                    labelpoint.Text = form1.lblPoint.Text.ToString();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else if (form1.status == "Директор КТС")
            {
                Random random = new Random();
                double chance = 0.60;
                double randomValue = random.NextDouble();
            ...
            {
                MessageBox.Show("ты слаб качайся");
            }
        }
